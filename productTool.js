...
<img style="width: ${values.autoWidth.width
    }; object-fit: contain; border-top-left-radius: 0.25rem; border-top-right-radius: 0.25rem; margin: 0 auto;" src="${values.productImage.url
    }" />
...
margin-bottom: 10px;" class="product-footer">
  ...
  line-height: 1.5; white-space: nowrap; width: calc(100% - 40px); background-color: ${values.productCTAColor
    }; color: ${values.productCTATextColor
    }; cursor: pointer; border-radius: 5px;"class="button no-underline" href="${values.productCTAAction.url
...
const freeShipping = (value) => {
  if (!value) return `<span class="product-freeShipping"></span>`;
    ...
    return `<span style= "color: #14a020; font-size: 15px; min-height: 23px; margin-bottom: 5px;" class="product-freeShipping"> Frete GrÃ¡tis </span>`;
};
    ...
    productContent: {
      ...
      options: {
        ...
        productTitle: {
          ...
          defaultValue: "TÃ­tulo do Produto",
          widget: "text",
        },
        productTitleColor: {
          label: "Cor do TÃ­tulo do Produto",
          defaultValue: "#000000",
          widget: "color_picker",
        },
        productDescription: {
          ...
          defaultValue:
            "Aqui vai a descriÃ§Ã£o do seu produto. Clique no box para editar e deixar do seu jeito.",
          widget: "rich_text",
        },
        productPrice: {
        ...
        produtctOldPrice: {
          label: "PreÃ§o Sem Desconto",
          defaultValue: "12,00",
          widget: "text",
        },
        productPriceColor: {
          label: "Cor do PreÃ§o do Produto",
          defaultValue: "#000000",
          widget: "color_picker",
        },
        productPriceBackgroundColor: {
          label: "Cor de Fundo PreÃ§o do Produto",
          defaultValue: "#ffffff",
          widget: "color_picker",
        },
        productFreeShipping: {
          label: "FrÃ©te GrÃ¡tis",
          defaultValue: false,
          widget: "toggle",
        },
        productCTA: {
        ...
        productCTATextColor: {
          label: "Texto da Cor do BotÃ£o",
          defaultValue: "#ffffff",
          widget: "color_picker",
        },
        productCTAAction: {
          label: "Tipo da AÃ§Ã£o",
          defaultValue: {
            name: "web",
            values: {
...
const getProduct = async (title, userToken) => {
  ...
  try {
    const url = `https://mensagex.com.br/s/ecomm/products/search?title=${removeSpecialCharacters(
      title
    )}&token=${userToken}`;
